...
def main():
    ...
    print("using {} images for training, {} images for validation.".format(train_num,
                                                                           val_num))
    net = create_model(num_classes=5).to(device)
    ...
    for epoch in range(epochs):
        ...
        print('[epoch %d] train_loss: %.3f  val_accuracy: %.3f  Red_acc: %.3f  Yellow_acc: %.3f  black_acc: %.3f  red_yellow_acc: %.3f  white_acc: %.3f' %(epoch + 1, val_loss, val_accurate,Red_acc,Yellow_acc,black_acc,red_yellow_acc,white_acc))
