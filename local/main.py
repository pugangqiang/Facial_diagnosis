...
root = "../data/train/local_data/cheek"  # 数据集所在根目录
...
def main():
    ...
    data_transform = {
        "train": transforms.Compose([transforms.RandomResizedCrop(224),
                                     ...
                                     transforms.ToTensor()]),
        "val": transforms.Compose([transforms.Resize(240),
    ...
    lr_line = []
    best_acc = 0.0
    savepath='./cheek_mobilenet_v3_small_checkpoints'
    ...
    for epoch in range(epochs):
        ...
        scheduler.step()
    with open('cheek_mobilenet_v3_small.csv','w', newline='') as f:
             f_csv = csv.writer(f)
